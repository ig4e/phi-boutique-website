export const create = (locale: "ar" | "en", route: string) => {
	return `<nav
    class="fixed top-0 inset-x-0 bg-primary py-2 z-30 max-w-lg mx-auto"
>
            ...
            <div class="flex items-center gap-4">
                <a
                    ...
                    >
                        ...
                        ></path></svg></a
                ><a
                    href="https://instagram.com/phi.boutique1?igshid=YWJhMjlhZTc="
                    ><svg
                        class="h-6 w-6"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                ><div class="flex items-center justify-between">
                    <div class="h-[53.03px]">
                        <img
                            ...
                            src="http://localhost:3000/images/assets/logo${
								locale === "ar" ? "-rtl" : ""
							}.png"
                            width="164.25"
                            height="53"
